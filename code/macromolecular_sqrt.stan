...
model {
  ...
  x0[3]    ~ normal(10,10);
  x0[4]    ~ normal(0.1,1);  
  theta[1] ~ normal(0.02,0.1);
  theta[2] ~ normal(0.234,0.1);
  theta[3] ~ normal(2.19,0.5);
  theta[4] ~ normal(1.43,0.5);
  theta[5] ~ normal(13.49,1);
  theta[6] ~ normal(9.59,0.5); 
  theta[7] ~ normal(0.05,0.01); 
